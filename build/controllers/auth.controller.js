...
exports.login = (0, errorhandler_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!email) {
        throw new error_handler_middleware_1.default("email required", 400);
    }
    if (!password) {
        throw new error_handler_middleware_1.default("password required", 400);
    }
...
// get profile
exports.profile = (0, errorhandler_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user_id = req.user._id;
    const user = yield user_models_1.default.findById(user_id);
    if (!user) {
        throw new error_handler_middleware_1.default('User Id not found', 404);
    }
    res.status(200).json({
